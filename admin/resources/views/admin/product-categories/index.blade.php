<x-admin-layout>
    ...
    <div class="mb-4">
        <a href="{{ route('admin.product-categories.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Add Category</a>
    </div>
            ...
            <tbody class="divide-y divide-slate-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 text-right space-x-2">
                        <a href="{{ route('admin.product-categories.edit', $c) }}" class="text-blue-600 hover:underline">Edit</a>
                        <form action="{{ route('admin.product-categories.destroy', $c) }}" method="POST" class="inline" onsubmit="return confirm('Delete this category?')">
                            @csrf
                            @method('DELETE')
