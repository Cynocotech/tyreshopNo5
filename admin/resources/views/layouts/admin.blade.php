    ...
    <div class="min-h-screen flex">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
            ...
            <nav class="px-6 py-7 space-y-3 admin-sidebar flex-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.account.edit') }}" class="flex items-center gap-4 px-4 py-4 rounded-xl {{ request()->routeIs('admin.account.*') ? 'active' : 'hover:bg-slate-100 text-slate-700' }}" @click="sidebarOpen = false">
