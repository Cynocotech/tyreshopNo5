...
echo "     cd ~/tyre/admin"
echo "     php artisan no5:import-services ../data/services.json --prune"
echo ""
...
echo "  3. git push"
echo "  4. On server: git pull && cd admin && php artisan no5:import-services ../data/services.json --prune"
echo ""
